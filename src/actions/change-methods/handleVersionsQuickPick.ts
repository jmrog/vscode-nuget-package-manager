...
export default function handleVersionsQuickPick({ selectedVersion, selectedPackage }: { selectedVersion: string, selectedPackage: string }): Promise<any> | Promise<never> {
            ...
            return new Promise((resolve, reject) => {
                fs.readFile(pickedProjFile, 'utf8', (err, data) => {
                    ...
                    parseString(data, (err, parsed: any = {}) => {
                        ...
                        try {
                            contents = createUpdatedProjectJson(parsed, selectedPackage, selectedVersion);
                        }
                        catch (ex) {
